...
export const metadata: Metadata = {
  title: { default: "Go Local Interactive", template: "%s | Go Local Interactive" },
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500;600;700&display=swap" rel="stylesheet" />
        {editorOrigin && (
